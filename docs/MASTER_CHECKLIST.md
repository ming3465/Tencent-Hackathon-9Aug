...
| Production build | OPENCODE | DONE | Latest verified Vite build: HTML 91.14 kB (15.99 kB gzip), initial JS 140.99 kB (41.21 kB gzip), lazy campaign scene 1,611.06 kB (377.18 kB gzip) |
...
- Production build and audit output, including HTML 91.14/15.99 kB gzip,
  initial JS 140.99/41.21 kB gzip, and lazy scene 1,611.06/377.18 kB gzip.
