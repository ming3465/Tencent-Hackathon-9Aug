...
| Codex (GPT-5) | `CampaignStateV1`, pure reducer, KampungMind, content and world-layout registries, versioned save, four-tab quest Journal, generated circular estate map, room-fit interior camera, registry-driven three-quarter Estate/Interior architecture, 22 contextual DoorViews, choice-correct shelters, Pause/Settings and audio ducking, original resident/environment art including tropical landscaping, 13 visual-novel portraits, four-frame locomotion, 14 approach-only details, responsive tap navigation, recoverable lazy loading, Web Audio, the Chapter 2 monsoon, building solidity/occlusion, `Phaser.AUTO` plus Canvas parity, generated-title integration, elder-led scam-awareness content, unit tests, full/demo browser campaigns, and refreshed artifacts/docs | Authored deterministic content and code-drawn visuals ahead of time and integrated one reviewed generated title asset; no runtime model or network path was added. Automated compact-layout/touch/renderer evidence is not presented as a real-device or human accessibility pass. |
...
| Unit tests | 85/85: 27 campaign, 31 match, 17 audio, 4 accessibility, 6 world/door/pause |
| Production build | HTML 86.59 kB (15.50 kB gzip); initial JS 129.02 kB (38.50 kB gzip); lazy campaign scene 1,602.13 kB (374.24 kB gzip) |
