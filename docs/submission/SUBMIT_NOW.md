...
> **Status as of 2026-08-03.** The submission form is NOT yet released — the
...
| U4 | **Miora key art** (miora.design, 1,000 free credits on signup). | 1 h | Still Miora-specific and still open. An auditable OpenAI style key, exact prompt, human review, and verified in-game translation now exist as cross-tool evidence; do not relabel them as Miora. Use the prepared Miora prompt for poster/social/deck output and log the real run. Feeds U5. |
...
Current truth as of 2026-08-03: **75 tests · 60 smoke checks · 0 vulnerabilities**.
