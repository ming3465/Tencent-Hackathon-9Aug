...
NOTES = [
    ...
    "Strict TypeScript, 90 unit tests (30 campaign, 31 match, 17 audio, 4 "
    "accessibility and 8 world-layout), 60 production-browser checks and zero "
    "known vulnerabilities support the current build. The private build is "
    "93.04 kB HTML (16.28 kB gzip), 135.02 kB initial JavaScript (39.95 kB "
    "gzip), and 1,602.10 kB lazy scene code (374.15 kB gzip). Connection-aware idle "
