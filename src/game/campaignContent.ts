...
export const CHAPTERS: readonly ChapterDefinition[] = [
  {
    ...
    journalObjective: "Listen to the Voice, then leave {player}'s house.",
  ...
  },
  {
    ...
    numberLabel: "Ending",
    title: "The Last Door",
    summary: "Return to {player}'s house and learn who the Voice has been waiting for.",
    journalObjective: "Return to {player}'s house. The last door is open.",
    entryLocationId: "y-flat",
  },
];
...
export const QUESTS: readonly QuestDefinition[] = [
  {
    ...
    summary: "Listen to the Voice and step out into the village.",
    optional: false,
    npcId: "voice",
...
export const LOCATIONS: readonly LocationDefinition[] = [
  ...
  {
    id: "estate",
    name: "Kampung SG Village",
    kind: "exterior",
    description: "A walkable village of houses, gardens, linkways, shops, and gathering places.",
    connections: [
      "y-flat",
      "mr-long-flat",
      "grandma-ros-kitchen",
    ...
    [
      {
        ...
        lines: [
          ...
          "You're new to walking around. Most people here just go door to gate to gone.",
        ],
        eligibility: {},
        chapterRelevance: 1,
      },
    ...
    [
      {
        ...
        lines: [
          "I mark out here. The house is too quiet and this is too loud, so it balances.",
...
const STORY_PROFILES: readonly NpcProfile[] = [
  profile(
    ...
    ["which door {player} has not opened", "why the house grows warmer"],
    ...
    [
      {
        ...
        lines: [
          "Wake up.",
          "No - don't reach for the light yet. Just listen.",
          "You have been chosen as the one who will stop the Fading, before it swallows everything whole.",
          "It is already in this village. It waits outside the houses nobody visits any more, and it takes the colour out of them one quiet day at a time.",
          "The details do not matter yet. What matters is that you go outside.",
          "Move with the arrow keys or WASD. Press E or Space when a person or a doorway is near.",
          "And {player} - nothing here can be got wrong. If a moment slips past you unchanged, you may return to it. I will see to that.",
        ...
        choices: [
          choice(
            ...
            [
              ...
              "Go outside, {player}. The latch is loose, and the first door opens inward.",
            ],
      ...
      },
      {
        ...
        kind: "reminder",
        title: "{player}'s House",
        lines: ["The village is through the lit doorway. Take all the time you need."],
        eligibility: {
          chapters: ["prologue"],
      ...
      },
      {
        ...
        title: "The Last Door",
        lines: [
          "You thought I was leading you through the village.",
          "I was the part of {player} that had begun to fade from its own doorway.",
          "I knew from the very first morning. I tried to tell you gently, that day. You did not hear it - grief closes ears long before it closes doors.",
          "So I gave you a reason to walk outside that was not about facing yourself. Every door you opened for someone else was practice for the one you could not yet face.",
          "They were real, though. Mr. Long's loneliness was real, and so was what you gave him. I only chose the order.",
          "The way back I promised you was mine to lend, not yours to keep. It has already gone. Reach for it.",
          "It was only ever meant to get you through a door. You do not need it now - you have shown me you can get it right the first time.",
          "Now look outside. Mei brought cuttings. Ravi brought chairs. Ros brought the whole kitchen.",
          "Nobody came to rescue {player}. They came because {player} had already made room for them.",
        ],
        choices: [
          choice(
            "open-last-door",
            ...
            [
              "Auntie Minah speaks first. “We weren't sure if you wanted company. But we didn't want you to be the one house we forgot.”",
              "The latch turns. It does not creak this time. Warm light fills the room, and every familiar voice answers.",
              "You were never the one who needed saving from the village, {player}. Only from forgetting you were part of it.",
            ],
