...
export const DOOR_DEFINITIONS: readonly DoorDefinition[] = [
  ...
  door({ id: "estate-prayer", sourceLocationId: "estate", targetLocationId: "prayer-hall", buildingId: "prayer-hall", label: "Enter the prayer hall", orientation: "north", style: "double-community", anchor: { x: 2180, y: 1050 }, approachPoint: { x: 2180, y: 1120 }, returnSpawn: { x: 2180, y: 1125 }, dimensions: { width: 82, height: 84 }, placard: "PRAYER HALL" }),
